...
public class FlLabeledFieldBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_alineacionStringField = 6;
    private static final int PROPERTY_ancestorListeners = 7;
    private static final int PROPERTY_anchoFijo = 8;
    private static final int PROPERTY_anchoLabel = 9;
    private static final int PROPERTY_autoCompleteFeature = 10;
    ...
    private static final int PROPERTY_control = 25;
    ...
    private static final int PROPERTY_defaultText = 29;
    private static final int PROPERTY_defaultTextOnLostFocusIfNull = 30;
    ...
    private static final int PROPERTY_editable = 34;
    private static final int PROPERTY_enabled = 35;
    private static final int PROPERTY_fieldName = 36;
    ...
    private static final int PROPERTY_formatNumber = 52;
    ...
    private static final int PROPERTY_invalidNumberErrorMessage = 66;
    private static final int PROPERTY_keyListeners = 67;
    private static final int PROPERTY_label = 68;
    private static final int PROPERTY_labelFont = 69;
    private static final int PROPERTY_labelForeground = 70;
    ...
    private static final int PROPERTY_onlyDigits = 89;
    ...
    private static final int PROPERTY_placeHolderGap = 96;
    private static final int PROPERTY_placeHolderIcon = 97;
    private static final int PROPERTY_placeHolderText = 98;
    private static final int PROPERTY_posicionLabel = 99;
    ...
    private static final int PROPERTY_required = 105;
    private static final int PROPERTY_requiredErrorMessage = 106;
    private static final int PROPERTY_rootPane = 107;
    private static final int PROPERTY_selectAllOnFocus = 108;
    private static final int PROPERTY_showing = 109;
    private static final int PROPERTY_size = 110;
    private static final int PROPERTY_stringFieldFont = 111;
    private static final int PROPERTY_stringFieldForeground = 112;
    private static final int PROPERTY_testingNumberFormat = 113;
    ...
    private static final int PROPERTY_tooShortErrorMessage = 117;
    ...
    private static final int PROPERTY_upperCase = 123;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_alineacionStringField] = new PropertyDescriptor ( "alineacionStringField", org.aguilar.swinglib.swing.fl.FlLabeledField.class, null, "setAlineacionStringField" ); // NOI18N
            properties[PROPERTY_alineacionStringField].setPreferred ( true );
            ...
            properties[PROPERTY_labelForeground] = new PropertyDescriptor ( "labelForeground", org.aguilar.swinglib.swing.fl.FlLabeledField.class, "getLabelForeground", "setLabelForeground" ); // NOI18N
            properties[PROPERTY_labelForeground].setPreferred ( true );
            ...
            properties[PROPERTY_stringFieldForeground] = new PropertyDescriptor ( "stringFieldForeground", org.aguilar.swinglib.swing.fl.FlLabeledField.class, "getStringFieldForeground", "setStringFieldForeground" ); // NOI18N
            properties[PROPERTY_stringFieldForeground].setPreferred ( true );
    ...
    private static final int METHOD_setValidation132 = 132;
    ...
    private static final int METHOD_validar144 = 144;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_setValidation132] = new MethodDescriptor(org.aguilar.swinglib.swing.fl.FlLabeledField.class.getMethod("setValidation", new Class[] {})); // NOI18N
            methods[METHOD_setValidation132].setDisplayName ( "" );
            ...
            methods[METHOD_validar144] = new MethodDescriptor(org.aguilar.swinglib.swing.fl.FlLabeledField.class.getMethod("validar", new Class[] {})); // NOI18N
            methods[METHOD_validar144].setDisplayName ( "" );
