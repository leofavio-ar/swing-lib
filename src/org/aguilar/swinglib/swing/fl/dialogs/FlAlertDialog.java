...
@Deprecated
/*
 * Reemplazada por <code>FlDialog</code>
 */
public class FlAlertDialog extends JOptionPane {

    private static final ImageIcon INFORMATION_TITLE_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px16/information.png"));
    private static final ImageIcon WARNING_TITLE_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px16/warning.png"));
    private static final ImageIcon EXCLAMATION_TITLE_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px16/exclamation.png"));
    private static final ImageIcon QUESTION_TITLE_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px16/question.png"));
    private static final ImageIcon INFORMATION_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px32/information.png"));
    private static final ImageIcon WARNING_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px32/warning.png"));
    private static final ImageIcon EXCLAMATION_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px32/exclamation.png"));
    private static final ImageIcon QUESTION_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px32/question.png"));
    private static final ImageIcon FULL_INFORMATION_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px48/information.png"));
    private static final ImageIcon FULL_WARNING_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px48/warning.png"));
    private static final ImageIcon FULL_EXCLAMATION_ICON = new ImageIcon(FlAlertDialog.class.getResource("/img/px48/exclamation.png"));
    ...
    public static int showInformationDialog(Frame parent, String message) {
        ...
        FlAlertDialog.OK_OPTION = AlertDialog.OK_OPTION;
        FlAlertDialog.CANCEL_OPTION = AlertDialog.CANCEL_OPTION;
        return dialogResult;
    }
    /**
     * Muestra un <code>AlertDialog</code> con íconos de información y un botón para Aceptar.
    ...
    public static void showFullInformationDialog(String message, int position) {
        FullAlertDialog alert = new FullAlertDialog(new Color(0x1836a8), position, 3000, false);
        alert.setForegroundColor(Color.WHITE);
        alert.showDialog(message, FULL_INFORMATION_ICON);
    }
    /**
    ...
    public static void showFullWarningDialog(String message, int position) {
        FullAlertDialog alert = new FullAlertDialog(new Color(0xd4d719), position, 3000, false);
        alert.setForegroundColor(Color.BLACK);
        alert.showDialog(message, FULL_WARNING_ICON);
    }
    /**
    ...
    public static void showFullErrorDialog(String message, int position) {
        FullAlertDialog alert = new FullAlertDialog(new Color(0xc51111), position, 3000, false);
        alert.setForegroundColor(Color.WHITE);
        alert.showDialog(message, FULL_EXCLAMATION_ICON);
    }
    /**
    ...
    public static void main(String[] args) {
        FlAlertDialog.showFullInformationDialog("mensaje", FlAlertDialog.TOP);
    }
